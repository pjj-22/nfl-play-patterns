...
class SituationGroupedTrie:
    """Separate trie per situation group (3rd & short, red zone, etc.)."""
    ...
    def insert_drive(
        ...
        Args:
            ...
            score_diffs: Optional score differentials (for score-aware grouping)
            team_pass_rates: Optional team pass rates (for team identity grouping)
            game_seconds_remaining: Optional game seconds remaining (for time context)
            posteam_types: Optional home/away for each play
        """
    ...
    def predict(
        ...
        Uses hierarchical fallback: specific context → base situation → league average.
        ...
        Args:
            ...
            score_diff: Optional score differential
            team_pass_rate: Optional team pass rate
            game_seconds_remaining: Optional game seconds remaining
            posteam_type: Optional home/away
